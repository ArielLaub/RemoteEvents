...
local host, port = "10.0.0.1", 6417


local messageRect = display.newRect( 0, 0, screenWidth, 20 )
messageRect:setFillColor( 64, 64, 64 )
messageRect.x, messageRect.y = centerX, screenY+screenHeight-messageRect.height*
.5
...
local function connect()
        setMessage( "connecting to "..host..", port "..port )
        ...
        if r == 1 then
                ...
                disconnect()
                setMessage( "not connected to "..host..": "..tostring(err), true )
        end
