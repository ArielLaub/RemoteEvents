...
local function setLabels( params )
	...
	xGravityLabel.text = "xGravity:\t"..string.sub( tostring( params.xGravity or "0" ), 1, 5 )
	yGravityLabel.text = "yGravity:\t"..string.sub( tostring( params.yGravity or "0" ), 1, 5 )
	zGravityLabel.text = "zGravity:\t"..string.sub( tostring( params.zGravity or "0" ), 1, 5 )
	xInstantLabel.text = "xInstant:\t"..string.sub( tostring( params.xInstant or "0" ), 1, 5 )
	yInstantLabel.text = "yInstant:\t"..string.sub( tostring( params.yInstant or "0" ), 1, 5 )
	zInstantLabel.text = "zInstant:\t"..string.sub( tostring( params.zInstant or "0" ), 1, 5 )
	isShakeLabel.text =  "isShake: \t"..tostring( params.isShake or "false" )
